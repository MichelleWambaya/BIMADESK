...
export function PrivacyPage() {
  return (
    <div className="max-w-2xl mx-auto px-5 py-12 space-y-4 text-[14px] text-ink-soft">
      ...
      <p>BimaDesk stores the client, policy, and communication records you enter so you can run your book of business. This includes names, phone numbers, national ID numbers where you choose to record them, and notes you write.</p>

      <h2 className="font-display text-lg text-ink pt-2">Payments</h2>
      <p>Subscription payments are processed by Safaricom M-Pesa or Paystack. BimaDesk never stores your M-Pesa PIN or full card number; those are handled directly by Safaricom and Paystack.</p>

      <h2 className="font-display text-lg text-ink pt-2">Your clients data</h2>
      <p>You are the data controller for the client information you enter. BimaDesk processes it on your behalf, scoped to your organization, and does not share it with other BimaDesk customers.</p>
