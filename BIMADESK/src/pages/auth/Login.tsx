    ...
    <div className="min-h-screen wb-aurora-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <p className="text-white/70 text-[13px] mt-1">Sign in to your BimaDesk workspace.</p>
        </div>
        ...
        <p className="text-center text-white/70 text-[13px] mt-4">
          New to BimaDesk? <Link to="/signup" className="text-white font-medium">Create an account</Link>
        </p>
      </div>
    </div>
  );
