...
// Tuned to the values you specified: the warning appears at 15 minutes
// of inactivity, and automatic sign out happens at 20 minutes, giving a
// 5 minute window to respond. Adjust both here if that balance changes.
    ...
    <div className="fixed inset-0 z-[70] bg-ink/40 flex items-center justify-center p-4">
      <div className="wb-card max-w-sm w-full p-6 text-center">
        ...
        <p className="text-[12.5px] text-ink-soft mt-1.5">
          You've been inactive for a while. For your clients' security, you'll be signed out in about five minutes.
        </p>
