      ...
      <div className="wb-glass-dark max-w-sm w-full p-7 text-center">
        ...
        {status === "invalid" && (
          <>
            ...
            <Link to="/" className="inline-block wb-btn-accent mt-4">Go to BimAdmin</Link>
          </>
        )}
        ...
        {(status === "valid" || status === "joining") && (
          <>
            ...
            <p className="text-white/60 text-[13px] mt-2">Accept to join their BimAdmin workspace.</p>
